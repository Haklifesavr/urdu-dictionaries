...
export default function MultipleSelectCheckmarks() {
  ...
  useEffect(() => {
    if(ceo.state.counter !== 0 && ceo.state.translate !== ""){
      manager.searches(ceo.state.translate, ceo.state.filters['0'], ceo.actions.setCounter, ceo.actions.setResult2, ceo.actions.setErrorMessage, ceo.actions.setLoading)
    } 
  },[ceo.state.counter]);
